...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Category::insert([
            [
                'name' => 'Semua Kategori',
                'path' => 'category/semua-kategori.png',
                'is_active' => 1,
            ],
            [
                'name' => 'Makanan Beku Olahan',
                'path' => 'category/makanan-beku-olahan.png',
                'is_active' => 1,
            ],
            [
                'name' => 'Daging Beku',
                'path' => 'category/daging-beku.png',
                'is_active' => 1,
            ],
            [
                'name' => 'Seafood Beku',
                'path' => 'category/seafood-beku.png',
                'is_active' => 1,
            ],
            [
                'name' => 'Sayur Beku',
                'path' => 'category/sayur-beku.png',
                'is_active' => 1,
            ],
            [
                'name' => 'Buah Beku',
                'path' => 'category/buah-beku.png',
                'is_active' => 1,
            ],
            [
                'name' => 'Makanan Siap Saji',
                'path' => 'category/makanan-siap-saji.png',
                'is_active' => 1,
            ],
        ]);
        ...
        Product::insert([
            [
                ...
                'price' => 35000,
                'quantity' => 50,
                'image' => 'products/nugget-ayam.png',
...
Dengan tekstur yang lembut dan cita rasa yang kaya, sosis sapi ini cocok untuk berbagai macam hidangan. Nikmati kelezatannya dalam sajian barbeque, tumis sayuran, atau sebagai tambahan dalam masakan pasta favorit Anda. Selain itu, sosis sapi ini juga dapat dijadikan camilan lezat saat dipanggang atau digoreng dengan sedikit minyak zaitun.',
            ...
            [
                ...
                'price' => 120000,
                'quantity' => 50,
                'image' => 'products/daging-sapi-slice.png',
            ...
            [
                ...
                'price' => 60000,
                'quantity' => 50,
                'image' => 'products/daging-ayam-fillet.png',
            ...
            [
                ...
                'price' => 150000,
                'quantity' => 50,
                'image' => 'products/daging-kambing-guling.png',
            ...
            [
                ...
                'price' => 80000,
                'quantity' => 50,
                'image' => 'products/udang-kupas.png',
            ...
            [
                ...
                'price' => 90000,
                'quantity' => 50,
                'image' => 'products/ikan-dori-fillet.png',
            ...
            [
                ...
                'price' => 15000,
                'quantity' => 50,
                'image' => 'products/wortel-potong.png',
            ...
            [
                ...
                'price' => 20000,
                'quantity' => 50,
                'image' => 'products/jagung-manis-pipil.png',
            ...
            [
                ...
                'price' => 30000,
                'quantity' => 50,
                'image' => 'products/mangga-beku.png',
            ...
            [
                ...
                'price' => 40000,
                'quantity' => 50,
                'image' => 'products/stroberi-beku.png',
            ...
            [
                ...
                'price' => 45000,
                'quantity' => 50,
                'image' => 'products/blueberry-beku.png',
