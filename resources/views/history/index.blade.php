    ...
    <section class="mt-16 bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            ...
            <div class="mb-8 flex flex-wrap gap-2">
                ...
                <a href="{{ route('history.index', ['status' => 'packed']) }}"
                    class="{{ request('status') == 'packed' ? 'bg-primary-500 text-white dark:bg-primary-500 dark:text-white' : 'text-primary-700 hover:bg-primary-50 dark:border-primary-400 dark:text-primary-400 dark:hover:bg-gray-800' }} rounded-full border border-primary-500 px-4 py-2 text-sm font-medium">
                    Dikemas
                </a>
            ...
            @elseif(request('status') == 'packed' || $status == 'packed')
                @include('history.partials.packed')
