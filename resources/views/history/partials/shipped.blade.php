@forelse ($groupedOrders as $groupTime => $orders)
    ...
    <div class="mx-auto mb-6 w-full rounded-lg border border-gray-100 bg-white p-4 shadow-sm">
        ...
        <div class="mt-4 flex items-center">
            ...
            <div class="ml-4 flex-grow">
                ...
                <div class="mt-1 inline-block rounded-[14px] bg-orange-100 px-2 py-1 text-xs text-orange-600">
                    Dikirim
                </div>
                <div class="flex">
                ...
                <div class="grid grid-cols-1 gap-3">
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex items-center">
                            ...
                            <div
                                class="mt-1 inline-block rounded-[14px] bg-orange-100 px-2 py-1 text-xs text-orange-600">
                                Dikirim
                            </div>
                        </div>
                    </div>
    ...
    <div class="rounded-lg border border-gray-100 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="flex flex-col items-center justify-center py-12 text-center">
            ...
            <h3 class="mb-2 text-xl font-medium text-gray-900 dark:text-white">Tidak ada pesanan yang sedang dikirim</h3>
            <p class="max-w-md text-gray-500 dark:text-gray-400">Pesanan Anda belum ada yang sedang dalam proses pengiriman.</p>
        </div>
    </div>
@endforelse
