<div class="w-full  mx-auto bg-white rounded-lg shadow-sm border border-gray-100 p-4">
    ...
    <div class="flex items-center mt-4">
        ...
        <div x-data="{ open: false }" class="text-right relative">
            <!-- Informasi Harga dan Tombol -->
            <div class="text-gray-800 font-semibold">Rp 120.000</div>
            <div class="text-gray-500 text-sm">x1</div>
            <button @click="open = true" class="mt-2 bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-[14px] text-sm">
                Beri Ulasan
            </button>
        
            
            {{-- @include('livewire.rating-modal', ['open' => 'open']) --}}
        </div>
