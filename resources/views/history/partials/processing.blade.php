<div class="w-full  mx-auto bg-white rounded-lg shadow-sm border border-gray-100 p-4">
    ...
    <div class="flex items-center mt-4">
        ...
        <div class="ml-4 flex-grow">
            ...
            <div class="inline-block bg-blue-100 text-blue-600 text-xs px-2 py-1 rounded-[14px] mt-1">
                dikemas
            </div>
            <div class="flex">
            ...
            <div class="grid grid-cols-1 gap-3">
                ...
                <div>
                    ...
                    <div class="flex items-center mt-1">
                        ...
                        <div class="inline-block bg-blue-100 text-blue-600 text-xs px-2 py-1 rounded-[14px]">
                            dikemas
                        </div>
                    </div>
                </div>
