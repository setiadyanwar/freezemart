<div class="w-full  mx-auto bg-white rounded-lg shadow-sm border border-gray-100 p-4">
    ...
    <div class="flex items-center mt-4">
        ...
        <div class="ml-4 flex-grow">
            ...
            <div class="inline-block bg-yellow-100 text-yellow-600 text-xs px-2 py-1 rounded-[14px] mt-1 mr-2">
                Belum Bayar
            </div>
            <div class="flex">
        ...
        <div class="text-right">
            ...
            <button class="mt-2 bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-[14px] text-sm">
