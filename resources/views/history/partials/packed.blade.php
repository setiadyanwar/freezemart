@forelse ($groupedOrders as $groupTime => $orders)
    ...
    <div class="rounded-lg border border-gray-100 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="flex flex-col items-center justify-center py-12 text-center">
            ...
            <h3 class="mb-2 text-xl font-medium text-gray-900 dark:text-white">Tidak ada pesanan yang sedang dikemas</h3>
            <p class="max-w-md text-gray-500 dark:text-gray-400">Pesanan Anda belum ada yang sedang dalam proses pengemasan.</p>
        </div>
    </div>
@endforelse
