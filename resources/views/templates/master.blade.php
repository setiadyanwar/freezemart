...
<body class="bg-gray-50 dark:bg-gray-800">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div>
                  ...
                  <form id="form-feedback" action="/" class="mt-4">
                    <div class="flex">
                      <input type="email" placeholder="Email Anda" class="w-full p-3 border border-gray-300 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-gray-700 dark:border-gray-700 dark:text-white" required/>
                      <button type="submit" class="bg-primary-500 text-white p-3 rounded-r-lg hover:bg-primary-600 focus:ring-2 focus:ring-primary-500">Subscribe</button>
                    </div>
                  </form>
                </div>
              </div>
    ...
    <div id="toast-feedback" class="fixed flex items-center w-full max-w-xs space-x-4 divide-x rtl:divide-x-reverse divide-gray-200 rounded-lg shadow bottom-5 right-5 dark:divide-gray-700 hidden" role="alert">
        <div id="toast-default" class="flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-white dark:bg-gray-700" role="alert">
            <div class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-primary-500 bg-gray-100 rounded-lg dark:bg-primary-500 dark:text-white">
