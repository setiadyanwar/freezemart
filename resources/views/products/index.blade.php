...
@section('content')
    ...
    <section class="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-12">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div id="dropdownSort1"
                        ...
                        <select
                            ...
                            <option value="cheapest" {{ request()->sort_by == 'cheapest' ? 'selected' : '' }}>Termurah
                            </option>
                            <option value="expensive" {{ request()->sort_by == 'expensive' ? 'selected' : '' }}>Termahal
                            </option>
                        </select>
                    </div>
                </div>
                        ...
                        <div class="pt-6">
                            ...
                            <div class="mt-4 flex items-center justify-between gap-4">
                                ...
                                <button type="button"
                                    ...
                                    <svg class="ms-0 me-0 h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <!-- Filter modal -->
        <form action="/products" method="get" id="filterModal" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="px-4 md:px-5">
                                    ...
                                    <div class="space-y-2">
                                        <div class="flex items-center">
                                            <input id="{{ $category->slug }}" type="checkbox"
                                                value="{{ $category->slug }}"
                                                class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-primary-500 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-500"
                                                name="categories[]"
                        ...
                        <div class="space-y-4" id="advanced-filters" role="tabpanel"
                            ...
                            <div>
                                ...
                                <label for="name"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cari nama
                                    produk</label>
