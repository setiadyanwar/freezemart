...
@section('content')
    ...
    <section class="relative bg-white py-24 antialiased dark:bg-gray-900">
        ...
        <div
            ...
            <a href="#" class="flex items-center md:justify-center">
                <svg class="h-8 hover:text-black dark:hover:text-white" viewBox="0 0 210 33" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <a href="#" class="flex items-center md:justify-center">
                <svg class="h-8 hover:text-black dark:hover:text-white" viewBox="0 0 76 33" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <a href="#" class="flex items-center md:justify-center">
                <svg class="h-8 hover:text-black dark:hover:text-white" viewBox="0 0 97 33" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <a href="#" class="flex items-center md:justify-center">
                <svg class="h-8 hover:text-black dark:hover:text-white" viewBox="0 0 74 33" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <a href="#" class="flex items-center md:justify-center">
                <svg class="h-6 hover:text-black dark:hover:text-white" viewBox="0 0 181 33" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
    ...
    {{-- category --}}
    <section class="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-16" id="category">
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            <div class="mb-4 flex items-center justify-between gap-4 md:mb-8">
                <h2 class="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Kategori Produk</h2>
