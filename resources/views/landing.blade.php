...
@section('content')
    {{-- hero --}}
    <section class="relative mb-6 bg-white pt-24 antialiased dark:bg-gray-900">
                ...
                <div class="flex flex-wrap">
                    <div class="mb-10 w-full lg:w-1/2">
                        ...
                        <div class="flex w-full items-center justify-between">
                            ...
                            <div class="mr-8 flex max-w-full gap-4 overflow-x-auto p-2 pb-2">
                    ...
                    <div x-data="{ submitted: false, input: '' }" class="mb-10 w-full lg:w-1/2">
