            ...
            <div class="mb-4 md:mb-8">
                ...
                <div class="flex flex-wrap">
                    ...
                    <div x-data="{ submitted: false, input: '' }" class="w-full mb-10 lg:w-1/2">
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div id="price-filters" class="flex flex-wrap gap-2">
                                                <button data-value="lt50"
                                                    class="px-4 py-2 text-sm font-medium text-gray-600 bg-white border border-gray-300 rounded-lg filter-btn dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300">
                                                    &lt; Rp50.000
                                                </button>
                        ...
                        <template x-if="submitted">
                            <div x-transition
                                class="p-6 space-y-4 text-center bg-white rounded-lg shadow-md dark:bg-gray-800">
