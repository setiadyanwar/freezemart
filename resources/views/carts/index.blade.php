    ...
    <section class="mt-8 bg-white py-8 antialiased dark:bg-gray-900 md:py-12">
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            <div class="mb-6 flex items-center">
                <a href="/beranda"
                    class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300">Beranda</a>
                <span class="mx-2">›</span>
                <span class="text-gray-900 dark:text-white">Keranjang</span>
            </div>

            <h2 class="mb-6 text-2xl font-bold text-gray-900 dark:text-white">Keranjang Belanja</h2>
            ...
            <form action="/buy-from-cart" method="post">
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    <div class="lg:col-span-2">
                        <div class="mb-4">
                            <label class="inline-flex items-center">
                                <input type="checkbox" class="form-checkbox rounded text-blue-600" id="select-all" checked>
                                <span class="ml-2 text-gray-700 dark:text-gray-300">Pilih
                                    Semua({{ $myCarts ? $myCarts->count() : 0 }})</span>
                            </label>
                        </div>
                        ...
                        @foreach ($groupedCarts as $group)
                            ...
                            <div class="mb-4 flex items-center rounded-lg border border-gray-200 p-4 dark:border-gray-700">
                                <div class="mr-3 flex-shrink-0">
                                    <input type="checkbox" class="form-checkbox product-checkbox rounded text-blue-600"
                                        name="selected_products[]" value="{{ $cartItem->product->slug }}" checked>
                                </div>
                                <div class="flex flex-1 items-center">
                                    <img class="mr-4 h-20 w-20 rounded-lg object-cover"
                                        ...
                                        <div class="flex flex-col md:flex-row md:items-start md:justify-between">
                                            <div>
                                                <a href="/products/{{ $cartItem->product->slug }}"
                                                    class="text-lg font-medium text-gray-900 hover:text-blue-600 dark:text-white">
                                            ...
                                            <div class="mt-3 flex flex-col md:mt-0 md:items-end">
                                                ...
                                                <div class="mt-2 flex items-center">
                                                    <div class="flex items-center">
                                                        <button type="button"
                                                            ...
                                                            class="decrement-qty flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 text-gray-600 hover:bg-gray-200">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            class="quantity w-10 border-0 bg-transparent text-center text-gray-900"
                                                            value="{{ $quantity }}" min="1"
                                                            data-price="{{ $cartItem->product->price }}"
                                                            data-slug="{{ $cartItem->product->slug }}" required readonly />

                                                        <button type="button"
                                                            data-target="counter-input-{{ $cartItem->product->slug }}"
                                                            class="increment-qty flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 text-gray-600 hover:bg-gray-200">
                                                            <svg class="h-3 w-3" aria-hidden="true"
                                                                xmlns="http://www.w3.org/2000/svg" fill="none"
                                                                viewBox="0 0 18 18">
                                                                <path stroke="currentColor" stroke-linecap="round"
                    ...
                    <div class="lg:col-span-1">
                        <div
                            class="sticky top-40 rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                            <h3 class="mb-6 text-xl font-semibold text-gray-900 dark:text-white">Ringkasan Pembelian</h3>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="mt-4 border-t border-gray-200 pt-4 dark:border-gray-700">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span class="text-lg font-semibold text-gray-900 dark:text-white" id="buy-total">Rp
                                            2.000</span>
                                    </div>
                                </div>

                                <button type="submit" id="checkout-button"
                                    class="flex w-full items-center justify-center rounded-lg bg-primary-500 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-600 focus:outline-none focus:ring-4 focus:ring-primary-300 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-primary-500 dark:hover:bg-primary-600 dark:focus:ring-primary-500"
...
@section('js-bottom')
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Hitung ulang harga berdasarkan checkbox yang sudah dicentang dari awal
