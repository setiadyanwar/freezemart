...
<div x-data="{ selectedConversationId: '{{ request()->conversation ?? $selectedConversationId }}' }"
    ...
    class="flex h-full w-full flex-col overflow-hidden bg-white/95 transition-all dark:bg-gray-900 sm:p-3">
    ...
    <main x-data
        @scroll.self.debounce="
           {{-- Detect when scrolled to the bottom --}}
            ...
            "
        class="relative h-full grow overflow-y-auto py-2" style="contain:content">
