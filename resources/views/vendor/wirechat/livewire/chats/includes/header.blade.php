...
<header class="sticky top-0 z-10 w-full px-3 py-2" dusk="header">
    ...
    <section class="flex items-center justify-between pb-2">
        ...
        <div class="flex items-center gap-x-3">
            ...
            {{-- <svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" class="w-6 h-6 text-gray-500 transition-colors duration-300 bi bi-x-octagon-fill dark:text-gray-400 dark:hover:text-gray-500 hover:text-gray-900" viewBox="0 0 16 16">
